...
import { advancedwatchgetviwjobs, watchgetapplicantuser, watchgetviwjobs, watchputapplicantuser, whatchadvancedSrarchgetuser, whatchaendjobUserdeleterequst, whatcharatingrequst, whatchemployeesgetuser } from './ApplicantuserSaga';
function* rootsaga()
{
    ...
    whatchemployeesgetuser(),whatchadvancedSrarchgetuser(),whatchaendjobUserdeleterequst(),whatcharatingrequst()])
}
